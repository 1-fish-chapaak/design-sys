...
- Left sidebar (240px expanded, 64px collapsed). Collapses at <1024px.
- Topbar 56px, paper-0 background, bottom 1px paper-200 border.
- Content panel: paper-50 background, 32px page padding at ≥768px,
  16px below.
